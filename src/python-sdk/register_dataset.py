...
def parse_args():
    ...
    parser.add_argument("-l", type=str, help="local path of the dataset folder", default='classical/python-sdk/data/')
    parser.add_argument("-p", type=str, help="Path on data store", default='classical/python-sdk/data/')
...
def main():
    ...
    if args.t == "local":
        ...
        Dataset.File.upload_directory(src_dir = 'classical/python-sdk/data/training/', target = (datastore, args.p), overwrite = True, show_progress = True)
